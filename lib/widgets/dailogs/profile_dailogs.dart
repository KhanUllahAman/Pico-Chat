      ...
      content: SizedBox(
        ...
        child: Stack(children: [
          ...
          Positioned(
            ...
            top: mq.height * .02,
            width: mq.width * .55,
            child: Text(user.name, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.white),)),
          Positioned(
             right: 8,
            top: 6,
            child: MaterialButton(
              ...
              shape: CircleBorder(),
              child: Icon(Iconsax.info_circle, color: Color.fromARGB(255, 241, 37, 132), size: 30,),
            )
            )
        ]
        ),
